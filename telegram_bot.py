...
# Only respond to private chat messages
    ...
    application.add_handler(CallbackQueryHandler(handle_portion_input, pattern="^portions_"))
application.add_handler(CallbackQueryHandler(handle_portion_input, pattern="^edit_portions_"))
